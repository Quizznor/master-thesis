...
In order to isolate the detector response stemming from shower particles only, a custom \Offline simulation using Geant4 is executed for a dataset of \todo{continue}

...
Poisson-distributed. This implies that generally, one in 14 time traces contains signal from one such low-energy background event. Coincidences of two accidental 
...
Electronic noise is the umbrella term given to the distortions that some signal is subject to from creation to readout. \todo{continue}

...
respectively \cite{AugerPrime, horandel2020precision}. \autoref{fig:sd-station} shows a schematic blueprint of each SD station.
...
\autoref{chap:physical-background}. Noteable are characteristic deviations from this powerlaw, as these contain information about \Ipeak  (\Qpeak):

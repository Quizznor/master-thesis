...
BOOTSTRAP="/cr/users/filip/scripts/BuildSimulation/bootstrap_$4.xml"
BOOTSTRAP_SRC="/cr/users/filip/scripts/BuildSimulation/bootstrap.xml.in"
...
/cr/users/filip/scripts/BuildSimulation/AdstExtractor/AdstComponentExtractor "$3/root_files/$4.root"
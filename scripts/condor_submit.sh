...
function show_help {
    ...
    echo "  --tensorflow     | -tf      -- require tfenv machine"
...
SCRIPTNAME=$(echo ${CONDOR_EXECUTABLE::-3} | cut -f2 -d/)
...
echo "Executable      = /cr/users/filip/scripts/condor_execute.sh" >> $JOB_FOLDER/run_$RUN_NO/file.sub

...
MockLinearModel = NNClassifier("minimal_conv2d_cut_0.00VEM/model_converged")
make_dataset(MockLinearModel, AllEvents, "one_layer_conv2d_cut_0.00VEM_random_traces")

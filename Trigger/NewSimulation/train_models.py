...
Events = EventGenerator("all", apply_downsampling = True, seed = 42, split = 1, q_peak = np.array([1,1,1]))
...
Assifier.make_signal_dataset(Events, "full_random_traces_downsampled_unrealistic_scale")

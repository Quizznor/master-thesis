...
root_path = "/cr/tempdata01/filip/QGSJET-II/CROSS_CHECK/ADST"
...
for e_bin in range(1, len(energy_bins)):
    ...
    for t_bin in range(1, len(theta_bins)): 
        ...
        save_file = f"/cr/tempdata01/filip/QGSJET-II/CROSS_CHECK/BINNED/{energy_bins[e_bin - 1]}_{energy_bins[e_bin]}__{int(theta_bins[t_bin - 1])}_{int(theta_bins[t_bin])}.csv"

...
root = "/cr/tempdata01/filip/QGSJET-II/LDF/"
...
while True:
    ...
    if remaining_files == 0: break
        ...
        os.system(f"/cr/users/filip/Simulation/calculateLDF/read_ADST/AdstReader {sys.argv[1]}")
        # print(f"moving target files in {source} to {move_to}")
        os.system(f"mv {source}/* {move_to}")

os.system("/cr/users/filip/Simulation/calculateLDF/read_ADST/put_together.py")

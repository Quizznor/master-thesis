...
BOOTSTRAP_SRC="/cr/users/filip/Simulation/calculateLDF/bootstrap.xml.in"
source /cr/users/filip/Simulation/.env/auger_env.sh

# Prepare bootstrap
INPUT='NR==59 {$0=FILE} '
PATTERN='NR==62 {$0=PATTERN1} NR==66 {$0=PATTERN2} '
OUTPUT='NR==81 {$0="/cr/tempdata01/filip/QGSJET-II/LDF/"ENERGY"/"NAME".root"} '
...
# /cr/users/filip/Simulation/AdstReader/AdstReader 3 $1

# # Delete root file
# # rm -rf "$3/root_files/$4.root"

# ???
rm -rf /cr/users/filip/Simulation/calculateLDF/HybridRec.dat
...
DESTINATION_DIR=f"/cr/tempdata01/filip/QGSJET-II/protons/{E_RANGE}/root_files"
...
for j in range(ALREADY_PRESENT, ALREADY_PRESENT + NUM_RETHROWS):
    ...
    try:
        ...
        subprocess.call([f"/cr/users/filip/Simulation/compareAdcVem/run_simulation.sh", *bash_arguments])

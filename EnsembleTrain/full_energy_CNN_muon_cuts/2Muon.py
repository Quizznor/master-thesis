...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/120_TwoLayer_FullBandwidth_AllEnergies_2Muon/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/120_TwoLayer_FullBandwidth_AllEnergies_2Muon/ensemble_{ensemble_no:02}", "two_layer_conv2d")

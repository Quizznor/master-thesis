...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/120_k30CNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/120_k30CNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}", "kernel_30")

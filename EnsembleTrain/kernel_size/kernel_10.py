...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/120_k10CNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/120_k10CNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}", "kernel_10")
...
try:
    ...
    f, df, n, n_trig, t = ThisNN.production_test(30000, apply_downsampling = True)

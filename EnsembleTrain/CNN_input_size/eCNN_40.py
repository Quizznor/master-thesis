...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/40_eCNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/40_eCNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}", "40_CNN")
...
try:
    ...
    f, df, n, n_trig, t = ThisNN.production_test(30000, apply_downsampling = True, window_length = 40)

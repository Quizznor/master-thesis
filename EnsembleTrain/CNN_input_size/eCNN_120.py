...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/120_eCNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/120_eCNN_Downsampled_AllEnergies_5_0VEM/ensemble_{ensemble_no:02}", "120_CNN")

...
try:
    ThisNN = NNClassifier(f"ENSEMBLES/120_LSTM_Downsampled_AllEnergies_0_2VEM/ensemble_{ensemble_no:02}")
    ...
    ThisNN = NNClassifier(f"ENSEMBLES/120_LSTM_3L_Downsampled_AllEnergies_0_2VEM/ensemble_{ensemble_no:02}", "simple_LSTM")
